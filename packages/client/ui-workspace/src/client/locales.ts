...
export const zh = {
  ...
  'field.folderPath': '目录路径',
  'field.folderPermission': '权限',
  'permission.read': '只读',
  'permission.write': '可写',
  'permission.both': '读写',
  'rename.folder.title': '重命名文件夹',
  'delete.folder': '删除文件夹',
  'delete.folderDesc': '将把“{name}”从文件夹列表中移除。其中的会话不会被删除，将回到其工作区或“未分组”下。',
  'menu.moveToFolder': '移动到文件夹…',
  'folder.move.title': '移动到文件夹',
  'folder.move.remove': '移出文件夹',
  'actions.folder.aria': '文件夹“{name}”的操作',
...
export const en = {
  ...
  'field.folderPath': 'Directory path',
  'field.folderPermission': 'Access',
  'permission.read': 'Read',
  'permission.write': 'Write',
  'permission.both': 'Read & write',
  'rename.folder.title': 'Rename folder',
  'delete.folder': 'Delete folder',
  'delete.folderDesc': 'This removes “{name}” from the folder list. Its sessions are not deleted; they return to their Workspace or under Ungrouped.',
  'menu.moveToFolder': 'Move to folder…',
  'folder.move.title': 'Move to folder',
  'folder.move.remove': 'Remove from folder',
  'actions.folder.aria': 'Folder actions for {name}',
