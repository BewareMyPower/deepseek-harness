...
import { folderIdSchema, folderViewSchema } from './folder.schema.ts'
...
export const hostFrameSchema = z.discriminatedUnion('type', [
  ...
  z.object({ type: z.literal('host/folder-changed'), folder: folderViewSchema }),
  z.object({ type: z.literal('host/folder-removed'), folderId: folderIdSchema }),
  z.object({ type: z.literal('host/folder-order-changed'), folderIds: z.array(folderIdSchema) }),
