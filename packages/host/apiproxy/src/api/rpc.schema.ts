...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('folder-not-found'), message: z.string(), details: z.object({ folderId: z.string() }) }),
  z.object({ code: z.literal('folder-session-conflict'), message: z.string(), details: z.object({ sessionId: z.string(), folderId: z.string() }) }),
  z.object({ code: z.literal('folder-move-invalid'), message: z.string(), details: z.object({ folderId: z.string(), sessionId: z.string(), beforeSessionId: z.string().optional() }) }),
